...
SELECT
    ...
    s.shopname
FROM cats c
JOIN shops s ON c.shops_id = s.id
GROUP BY c.id;
...
WHERE NOT c.`name` = "Murzik" AND c.name != "Zuza";

-- Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.
SELECT
	a.an_name AS `name`,
	a.an_price AS price,
    o.ord_datetime AS `data`
FROM analysis a
JOIN orders o ON a.an_id = o.ord_an
-- WHERE o.ord_datetime BETWEEN "2020-02-05" AND "2020.02.12" + INTERVAL "1 week"
